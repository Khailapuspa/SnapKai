            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        ...
                        <span className="text-900 font-medium text-2xl line-height-3 mr-8">Snapkai</span>
                    </Link>
                ...
                <div
                    ...
                    style={{
                        background: `url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.merdeka.com%2Ftrending%2F10-pemandangan-keren-di-indonesia-wajib-dikunjungi-langsung-kln.html&psig=AOvVaw2hin6c5VBUgccVggX1BYwT&ust=1707198328791000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCLD_qcG_k4QDFQAAAAAdAAAAABAE') center center / cover no-repeat, linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), radial-gradient(77.36% 256.97% at 77.36% 57.52%, #EEEFAF 0%, #C3E3FA 100%)`,
                        clipPath: 'ellipse(150% 87% at 93% 13%)'
                    }}
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4">
                        <h1 className="text-6xl font-bold text-gray-900 line-height-2">
                            <span className="font-light block"></span>Mau berbagi momen sederhana dan praktis ?
                        </h1>
                        <p className="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">
                            SnapKai aja! teman santai untuk berbagi momen-momen tak terlupakan. Sederhana, praktis, dan ramah pengguna. Bagikan kebahagiaan visual Anda bersama SnapKai!
                        </p>
                    ...
                    <div className="grid justify-content-center">
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">Discover ease in every step with an intuitive interface.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">Enjoy a fresh design that enhances the user experience.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">Comprehensive documentation to ensure you always have clear guidance.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">Responsive layout for a consistent user experience across various devices.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">Dark mode for eye comfort whenever you need it.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <span className="text-600">Implement modern practices for a contemporary and efficient experience.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <div className="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
                                <h3 className="text-gray-900 mb-2">Khaila Puspa Maharani</h3>
                                <span className="text-gray-600 text-2xl">Gallery Mastermind</span>
                                <p className="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-4" style={{ maxWidth: '800px' }}>
                                    "Creating my own gallery with this app has been an absolute delight! The seamless design and user-friendly features make it a breeze to showcase my favorite moments. It's like having my own virtual art exhibition
                                    where every click reveals a masterpiece. The customization options are a game-changer, allowing me to curate a space that truly reflects my style. Forget the mundane, embrace the extraordinary with this gallery
                                    website app!"
                                </p>
                                <img src="/demo/images/landing/logo.png" className="mt-4" alt="Your Company Logo" style={{ width: '80px', height: 'auto' }} />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid my-8 pt-2 md:pt-8">
                        <div className="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
                            ...
                            <span className="text-700 text-2xl line-height-3 mr-0 md:mr-2" style={{ maxWidth: '650px' }}>
                                It seems like you're looking for a long, engaging sentence that can be used as a caption or tagline for a gallery application on a laptop or computer. Here's a suggestion: "Immerse yourself in a captivating world of
                                visual artistry, where every click unveils a stunning array of images, designed to inspire your creativity and transform your desktop into a personalized canvas of expression." This sentence highlights the beauty and
                                diversity of the gallery, while also emphasizing the user's ability to customize their experience. It's long enough to convey a message, but still engaging and relevant to the application's purpose.
                            </span>
                        </div>
                    ...
                    <div className="grid justify-content-between">
                        <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
                            <Link href="/" className="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer">
                                ...
                                <span className="font-medium text-3xl text-900">Snapkai</span>
                            </Link>
                        </div>
